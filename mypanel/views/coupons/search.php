...
<script type="text/javascript"> 
	...
	$('.Submit_BTN').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>coupons/display_search_results/AJAX/Y/',{Coupon_Number:Coupon_Number},function(data){
	...
	<table width="100%"  border="0" cellpadding="3" cellspacing="0" dir="ltr">
	  <tr>
	    <td width="79%"><div align="right">
	      <input id="Coupon_Number" name="Coupon_Number" type="text" size="40"></div></td>
	    <td width="21%"><div align="right">رقــم الـكـوبــون</div></td>
	  </tr>
 		<tr>
		 <td>
