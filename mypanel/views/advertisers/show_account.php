...
<script type="text/javascript"> 
	...
	$('.Submit_Main_BTN_Add').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>advertisers/submit_members_edit/AJAX/Y/',{ID:ID,First_Name:First_Name,Company_Name:Company_Name,Phone_Number:Phone_Number,Cell_Phone:Cell_Phone,user_name:user_name,Time_Stamp:'<?php echo $Time_Stamp;?>',Contact_Email:Contact_Email},function(data){
