...
<script type="text/javascript"> 
	$(document).ready(function() { 
		...
		$('.Del_Btn').click(function(){
			...
			var ID = $(this).attr('id');
			$.post('<?php echo __LINK_PATH;?>ads/delete_selected_sub_cat/AJAX/Y/',{ID:ID},function(data){
					$('#Container').html(data);
				});
			}
			});	
		...
		$('.Paginate').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>ads/ads_sub_cat/AJAX/Y/',{Page:Page},function(data){
				$('#Container').html(data);
		...
		$('.Submit_Main_BTN_Edit').click(function(){
			...
			if(Cat_Name == '')
				...
				{
					$.post('<?php echo __LINK_PATH;?>ads/submit_edit_sub_cat/AJAX/Y/',{ID:ID,Cat_Name:Cat_Name,Time_Stamp:'<?php echo $Time_Stamp;?>'},function(data){
		...
		$('.Submit_Main_BTN_Add').click(function(){
			...
			if(Cat_Name == '')
				...
				{
					$.post('<?php echo __LINK_PATH;?>ads/submit_add_sub_cat/AJAX/Y/',{Cat_Name:Cat_Name,Time_Stamp:'<?php echo $Time_Stamp;?>'},function(data){
							setTimeout('$.fn.myFunction()',100);
						   $.fn.myFunction = function() { 
								$.getJSON('<?php echo __SCRIPT_PATH;?>json/<?php echo $Time_Stamp;?>.json',function(json){
								var Flag = json.flag;
...
foreach($results as $rows)
	...
	?>
	<div>
	<div dir="rtl"><?php echo  $rows->Sub_Cat_Name;?>
