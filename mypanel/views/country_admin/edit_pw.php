...
<script type="text/javascript"> 
	...
	$('.Submit_Main_BTN_Add').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>country_admin/submit_new_pw/AJAX/Y/',{ID:ID,password:password,password_2:password_2,Time_Stamp:'<?php echo $Time_Stamp;?>'},function(data){
