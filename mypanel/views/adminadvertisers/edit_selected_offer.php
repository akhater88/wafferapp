...
<script type="text/javascript"> 
	...
	$('.Return_MSG').click(function(){
			$('#FlyBox').show('slow').animate({top: '170px',right:'5px' }, 200).css({'z-index' : '10'});
		});
...
<table width="100%">
  ...
  <tr>
    	<td><div align="right"><input type="button" name="Sub_Menu_Btn" value="نـشــر" class="Submit_Main_BTN_Add_Save">
    	&nbsp;<input type="button" name="Sub_Menu_Btn" value="حـفـظ كـمـسـودة" class="Submit_Main_BTN_Add"></div></td>
