...
<script type="text/javascript"> 
	...
	$('.Submit_Main_BTN_Add').click(function () {
		...
		$.post('<?php echo __LINK_PATH;?>adminadvertisers/display_search_results_logs/AJAX/Y/',{ID:ID,Offer_Type:Offer_Type,Start_Date:Start_Date,End_Date:End_Date,Time_Stamp:'<?php echo $Time_Stamp;?>'},function(data){
...
<table width="100%">
  ...
  <tr>
	...
	<tr>
		...
		<option value="1">إضــافــة</option>
		<option value="2">تـعـديــل</option>
		<option value="3">مـســح</option>
		<option value="4">تـسـجـيـل دخـول</option>
		<option value="5">تـسـجـيـل خـروج</option>
		</select>
		</div>
		</td>
    	<td><div align="right">نــوع الـعـمـلـيــة</div></td>
  	</tr>
  <tr>
