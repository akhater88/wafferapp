...
foreach($results as $rows)
	...
	<tr>
		...
		<td><div align="center" style="cursor:pointer; color:#0066FF " onClick="RedirectModified('<?php echo __LINK_PATH;?>adminadvertisers/show_client_offers/Member/<?php echo $ID;?>/');"><?php echo $Full_Name;?></div></td>
	</tr>
	<?php
	}
?>
