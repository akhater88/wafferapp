...
if(count($Final_OID))
	{
		...
		foreach($Final_OID as $value)
			...
			<tr class="<?php echo $Style;?>">
		  	<td style="width: 135px; padding-top:4px;" class="table-orange2"><span style="cursor:pointer " onClick="$.editData('تـعـديـل مـعـلــومـات الـعـمـيــل','<?php echo __LINK_PATH;?>adminadvertisers/edit_selected_offer_from_pending/Member/<?php echo $value;?>/AJAX/Y/',950,600)"><img alt="" src="<?php echo __SCRIPT_PATH;?>images/details.jpg" width="80" height="24" class="style2" border="0" /></span></td>
