...
<script type="text/javascript"> 
	...
	$('#Services').change(function(){
			...
			$.post('<?php echo __LINK_PATH;?>operators/submit_status_name/AJAX/Y/',{Service_ID:Service_ID,Merchant_ID:Merchant_ID},function(data){
...
if(count($Sub_Cat_IDs))
  ...
  <tr>
	 ...
	 <td width="12%"><div align="right">الـخـدمــة</div></td>
  </tr>
</table>
