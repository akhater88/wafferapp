...
<script type="text/javascript"> 
	...
	$('#Cities').change(function(){
			...
			$.post('<?php echo __LINK_PATH;?>operators/submit_category_name/AJAX/Y/',{City_ID:City_ID,Merchant_ID:Merchant_ID},function(data){
...
if(count($City_IDs))
  ...
  <tr>
	 ...
	 <td width="12%"><div align="right">الـمـديـنــة</div></td>
  </tr>
</table>
