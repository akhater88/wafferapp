...
<script type="text/javascript"> 
	...
	$('.Submit_Main_BTN_Add').click(function(event){
			...
			$.post('<?php echo __LINK_PATH;?>sales/submit_members_edit/AJAX/Y/',{ID:ID,Level:Level,First_Name:First_Name,user_name:user_name,Company_Name:Company_Name,Phone_Number:Phone_Number,Cell_Phone:Cell_Phone,Sender_Name:Sender_Name,Address:Address,Starts_Date:Starts_Date,End_Date:End_Date,Ads_Cat:Ads_Cat,Country_Name:Country_Name,SID_Values:SID_Values,Amount:Amount,Time_Stamp:Time_Stamp},function(data){
