...
<script type="text/javascript"> 
		...
		$('.Paginate').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>operators/add_offer_start/AJAX/Y/',{Page:Page},function(data){
				$('#Container').html(data);
...
foreach($results as $rows)
	...
	<tr>
		...
		<td><div align="center" style="cursor:pointer; color:#0066FF " onClick="RedirectModified('<?php echo __LINK_PATH;?>operators/show_client_offers/Member/<?php echo $ID;?>/');"><?php echo $Full_Name;?></div></td>
	</tr>
	<?php
	}
?>
