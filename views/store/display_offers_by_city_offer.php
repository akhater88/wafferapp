<script type="text/javascript"> 
	...
	$('#Display_Cities_Offer').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>store/display_cities_offer/AJAX/Y/',{Country_ID:Country_ID,Member:Member},function(data){
				$('#Offers_By_City_Offer').html(data);
			});
	...
	$('.bg5').click(function(){
			...
			var Country_ID = '<?php echo $Country_ID;?>';
			var Member = '<?php echo $Member;?>';
			$.post('<?php echo __LINK_PATH;?>store/display_merchants_offers_offer/AJAX/Y/',{MID:MID,City_ID:City_ID,Sub_Cat:Sub_Cat,Country_ID:Country_ID,Member:Member},function(data){
				$('#Offers_By_City_Offer').html(data);
			});
...
<div class="mobile-back1"><a href="#z"><img alt="" src="<?php echo __SCRIPT_PATH;?>images/back1.png" width="39" height="14" border="0" id="Display_Cities_Offer"/></a></div>
</div>