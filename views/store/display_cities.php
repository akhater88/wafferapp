<script type="text/javascript"> 
	...
	$('#Display_Country').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>store/display_offer_post/AJAX/Y/',{Member:Member},function(data){
				$('#Discounts').html(data);
			});
	...
	$('.Offers').click(function(){
			...
			var Member = '<?php echo $Member;?>';
			$.post('<?php echo __LINK_PATH;?>store/display_offers_by_city/AJAX/Y/',{City_ID:City_ID,Country_ID:Country_ID,Member:Member},function(data){
