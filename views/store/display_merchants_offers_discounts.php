<script type="text/javascript"> 
	...
	$('#Display_Offers_By_Cities').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>store/display_offers_by_city/AJAX/Y/',{Country_ID:Country_ID,City_ID:City_ID,Member:Member},function(data){
...
if(count($Offers_Array))
	...
	{
	?>
	<div class="mobile-bg-inner2">لا تـوجـد تنـزيـلات حـالـيــا</div >
	<?php
	}
?>
</div>
