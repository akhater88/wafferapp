...
<table width="100%"  border="0" cellpadding="3" cellspacing="0" dir="ltr">
  <tr>
    ...
    <td width="28%"><div align="right">الإســم</div></td>
  </tr>
   
   <tr>
    <td width="72%">
	<div align="right" dir="rtl"><span><input name="user_name" type="text" id="user_name" size="30" dir="<?php echo $Dir;?>"></span>&nbsp;<span style="font-size:12px; color:#FF0000 ">البريد الإلـكـتـرونـي</span></div>
	</td>
    <td width="28%"><div align="right">إســم الـمــستـخـدم</div></td>
  </tr>
   <tr>
    <td width="72%">
	<div align="right" dir="rtl"><span><input name="password" type="password" id="password" size="30" dir="<?php echo $Dir;?>"></span>&nbsp;<span style="font-size:12px; color:#FF0000 ">أكـثـر مـن خـمـسـة حـروف</span></div>
	</td>
    <td width="28%"><div align="right">كـلـمــة الـســر</div></td>
  </tr>
   <tr>
    <td width="72%">
    ...
    <td width="28%"><div align="right">تـأكـيـد كـلـمـة الـسـر</div></td>
  </tr>
  <?php
  if($Level == '2')
  	{
	?>
	<tr>
    	<td width="72%"><div align="right"><input name="Company_Name" type="text" id="Company_Name" size="30" dir="<?php echo $Dir;?>">
    	</div></td>
    	<td width="28%"><div align="right">إسـم الـشركــة</div></td>
  	</tr>
	<tr>
    	<td width="72%"><div align="right"><input name="Phone_Number" type="text" id="Phone_Number" size="30" dir="<?php echo $Dir;?>">
    	</div></td>
    	<td width="28%"><div align="right">رقـم الـهـاتـف</div></td>
  	</tr>
	<tr>
    	<td width="72%"><div align="right"><input name="Cell_Phone" type="text" id="Cell_Phone" size="30" dir="<?php echo $Dir;?>">
    	</div></td>
    	<td width="28%"><div align="right">رقـم الـجـوال</div></td>
  	</tr>
	<tr>
    	<td width="72%"><div align="right"><input name="Sender_Name" type="text" id="Sender_Name" size="30" dir="<?php echo $Dir;?>">
    	</div></td>
    	<td width="28%"><div align="right">إسـم الـمـرســل</div></td>
  	</tr>
	<tr>
    	<td width="72%"><div align="right">
		<textarea id="Address" name="Address" cols="40" rows="8" dir="<?php echo $Dir;?>"></textarea>
    	</div></td>
    	<td width="28%"><div align="right">الـعــنــوان</div></td>
  	</tr>
	<tr>
    	<td width="72%"><div align="right"><input name="Starts_Date" type="text" id="Starts_Date" size="10" value="<?php echo $Today;?>" readonly dir="<?php echo $Dir;?>">
    	</div></td>
    	<td width="28%"><div align="right">تـاريـخ بـدء الإشـتـراك</div></td>
  	</tr>
	<tr>
    	<td width="72%"><div align="right"><input name="End_Date" type="text" id="End_Date" size="10" value="<?php echo $Today;?>" readonly dir="<?php echo $Dir;?>">
    	</div></td>
    	<td width="28%"><div align="right">تـاريـخ إنـتـهـاء الإشـتـراك</div></td>
  	</tr>
	<tr>
    	<td width="72%"><div align="right">
    	...
    	<td width="28%"><div align="right">الـتـصـنـيـف الـدعـائــي</div></td>
  	</tr>
	<tr>
    	<td width="72%"><div dir="rtl">
		<?php
    	...
    	<td width="28%"><div align="right">الـخـدمــات</div></td>
  	</tr>
	<tr>
    	<td width="72%"><div align="right">
    	...
    	<td width="28%"><div align="right">الـبـلــد</div></td>
  	</tr>
	<tr>
    	<td width="72%"><div align="right"><input name="Amount" type="text" id="Amount" size="8" dir="<?php echo $Dir;?>">
    	</div></td>
    	<td width="28%"><div align="right">الـمـبـلــغ الـمـدفــوع</div></td>
  		</tr>
	<?php
	}
  ...
  ?>
  <tr>
    	<td width="72%"><div align="right"><input type="button" name="Sub_Menu_Btn" value="إرسـال" class="Submit_Main_BTN_Add"></div></td>
