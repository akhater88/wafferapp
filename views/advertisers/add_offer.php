...
<script type="text/javascript"> 
	...
	$('.Submit_Main_BTN_Add').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>advertisers/submit_new_offer/AJAX/Y/',{Offer_Title:Offer_Title,Start_Date:Start_Date,End_Date:End_Date,Ads_Sub_Cat:Ads_Sub_Cat,Offer_Content:Offer_Content,City:City,Time_Stamp:'<?php echo $Time_Stamp;?>'},function(data){
...
<table width="100%">
   <tr>
    <td width="89%"><div align="right"><input name="Offer_Title" type="text" id="Offer_Title" size="30" dir="<?php echo $Dir;?>"></div></td>
  ...
  <tr>
     <td colspan="2"><div align="right"><textarea id="editor1" name="Offer_Content"></textarea></div></td>
  </tr>
   <tr>
     <td colspan="2">&nbsp;</td>
  </tr>
  <tr>
    	<td><div align="right"><input name="Start_Date" type="text" id="Start_Date" size="10" value="<?php echo $Today;?>" readonly dir="<?php echo $Dir;?>"></div></td>
