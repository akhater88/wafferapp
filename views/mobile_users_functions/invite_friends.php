...
<div id="login-tabs">
	...
	$myfunctions->display_mobile_menu('2');
	?>
</div>
...
<table width="100%"  border="0" cellpadding="5">
  <tr>
      <td><div align="right" dir="rtl"><span> الـرجـاء إدخـال عـنـاويـن الـبـريـد الإلـكـتـرونـي عـلـى الـنـحـو الـتـالـي : </span><span style="margin:10px; font-size:11px; color:#FF0000 ">Email 1,Email 2, Email 3</span></div></td>
  </tr>
  <tr>
    <td>
    <div align="right"><textarea style="width: 567px; border:1px #bebfc0 solid; height: 106px" id="Emails" cols="50" rows="10"></textarea></div>
    </td>
  </tr>
  <tr>
      <td ><div align="right">الـرسـالــة الـمــراد إرفـاقـهــا إلــى أصـحـاب الـبـريـد الإلكـتـرونــي</div></td>
  </tr>
  <tr>
  	 <td>
  	 	<div align="right"><textarea style="width: 567px; border:1px #bebfc0 solid; height: 106px" id="MSG" cols="50" rows="5" dir="rtl"></textarea></div>
  	 </td>
  	</tr>
  ...
  <tr>
    <td>
    	<div align="right">
    		<img alt="" src="<?php echo __SCRIPT_PATH?>images/sent-form.jpg" width="75" height="25"  class="Submit_BTN"/>
    	</div>
    </td>
  </tr>
