<script type="text/javascript"> 
	...
	$('.Offers_new').click(function(){
			var City_ID = $(this).attr('id');
			var Country_ID = '<?php echo $Country_ID;?>';
			var Member = '<?php echo $Member;?>';
			$.post('<?php echo __LINK_PATH;?>store/display_offers_by_city_new/AJAX/Y/',{City_ID:City_ID,Country_ID:Country_ID,Member:Member},function(data){
				$('#Discounts_New').html(data);
			});
...
<div class="mobile-text1"><br/><br/>الرجاء اختيار المدينة:
			...
			foreach($City_ID_Array as $Value)
				{
					if($Counter == 1)
						...
						?>
						<tr>
						<td id="<?php echo $Value;?>" valign="top" align="center" style="width: 70px" class="Offers_new">
					...
					if($Counter == 2)
						{
						?>
						<td id="<?php echo $Value;?>" valign="top" align="center" class="Offers_new">
						<img alt="" src="<?php echo __SCRIPT_PATH;?>images/bubble_2.png" />&nbsp;<?php echo $City_Name_Array[$Index];?></td>
						<?php
						}
					$Counter++;
		...
		<div class="mobile-back1"><a href="#z"><img alt="" src="<?php echo __SCRIPT_PATH;?>images/back1.png" width="39" height="14" border="0" id="Display_Country_New"/></a></div>
	</div>