<script type="text/javascript"> 
	...
	$('#Display_Cooffee').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>services/display_offer_post_coffee_shops/AJAX/Y/',{Member:Member,Ads_Cat:Ads_Cat},function(data){
	...
	$('.Offers').click(function(){
			...
			var Member = '<?php echo $Member;?>';
			var Ads_Cat = '<?php echo $Ads_Cat;?>';
			$.post('<?php echo __LINK_PATH;?>services/display_offers_by_city_coffee_shops/AJAX/Y/',{City_ID:City_ID,Country_ID:Country_ID,Member:Member,Ads_Cat:Ads_Cat},function(data){
				$('#Offers_Coffee_Shops').html(data);
			});
...
<div class="mobile-text1"><br/><br/>الرجاء اختيار المدينة:
		...
		<div class="mobile-back1"><a href="#z"><img alt="" src="<?php echo __SCRIPT_PATH;?>images/back1.png" width="39" height="14" border="0" id="Display_Cooffee"/></a></div>
	</div>