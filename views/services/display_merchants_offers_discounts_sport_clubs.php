<script type="text/javascript"> 
	...
	$('#Display_Offers_By_Cities_Coffee_Shops').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>services/display_offers_by_city_coffee_shops/AJAX/Y/',{Country_ID:Country_ID,City_ID:City_ID,Member:Member,Ads_Cat:Ads_Cat},function(data){
				$('#Offers_content_sport_clubs').html(data);
			});
...
<div id="Offers_content_sport_clubs">
<div class="mobile-text4" style="overflow:auto; direction:ltr">
<div class="mobile-bg4"><a href="#z" class="bg1" style="text-decoration:none; font-weight:bold "><?php echo $Sender_Name;?></a></div >
<?php
$Counter = 0;
if(count($Offers_Array))
	{
		foreach($Offers_Array as $Value)
			...
			?>
			<div class="mobile-bg-inner4" id="<?php echo $BG;?>"><?php echo $Value;?></div >
			<?php
			$Counter++;
			}
	}
	...
	{
	?>
	<div class="mobile-bg-inner4">لا تـوجـد مـعـلـومـات حـالـيــا</div >
	<?php
	}
?>
</div>
