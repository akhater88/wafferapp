<script type="text/javascript"> 
	...
	$('#Display_Cities_Sport_Clubs').click(function(){
			...
			$.post('<?php echo __LINK_PATH;?>services/display_cities_sport_clubs/AJAX/Y/',{Country_ID:Country_ID,Member:Member,Ads_Cat:Ads_Cat},function(data){
				$('#Offers_By_City_Sport_Clubs').html(data);
			});
	...
	$('.bg5').click(function(){
			...
			var Member = '<?php echo $Member;?>';
			var Ads_Cat ='<?php echo $Ads_Cat;?>';
			$.post('<?php echo __LINK_PATH;?>services/display_merchants_offers_discounts_sport_clubs/AJAX/Y/',{MID:MID,City_ID:City_ID,Country_ID:Country_ID,Member:Member,Ads_Cat:Ads_Cat},function(data){
				$('#Offers_By_City_Sport_Clubs').html(data);
			});
...
<div id="Offers_By_City_Sport_Clubs">
...
<div class="mobile-back1"><a href="#z"><img alt="" src="<?php echo __SCRIPT_PATH;?>images/back1.png" width="39" height="14" border="0" id="Display_Cities_Sport_Clubs"/></a></div>
</div>