...
<script type="text/javascript"> 
		...
		$('.Submit_BTN').click(function(){
			...
			if(Title == '')
				...
				{
				$.post('<?php echo __LINK_PATH;?>menus_pages_subs/submit_new_page_sub_sub/AJAX/Y/',{ID:ID,Title:Title,Content:Content},function(data){
...
<tr>
  ...
  <tr>
    <td width="87%"><div align="right"><input name="Title" type="text" id="Title" size="40" dir="<?php echo $Dir;?>">
    </div></td>
