            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><img src="<?php echo __SCRIPT_PATH;?>assets/images/logo_waffer.png" alt="" style="height: 100px"/>WafferApp</a>
                    </div>
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                              ...
                                              <p class="forgot"> <a href="#" id="resend_password_link">Forget Passowrd?</a> </p>
                                              <p class="forgot"> <a href="<?php echo __LINK_PATH?>mobile_users/create_account" id="resend_password_link">Register.</a> </p>
                                        	  <div id="pw_recovery" style=" display:none ">
                                        	  <p style="font-size:12px ">Email</p>
                                        	  <p><input id="EmailPW" type="text" /></p>
                                        	  <p><input type="button" id="signin_submit2" value="  Send  "/>
                                        	  </p>
                                        	  </div>
...
<!--                                   </div> -->
                            ...
                            <div class="contact-number text-right"> 
                                <ul><li class="">info@wafferapp.com</li></ul>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="homepage-style">
                        ...
                        <div class="top-arrow hidden-xs text-center"><img src="<?php echo __SCRIPT_PATH;?>assets/images/top-arrow.png" alt="" /></div>

                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="unique-apps">
                                <h2>WafferApp<br>Save Your Money </h2>
                                <p>
                                		You have to use this website because it will save your Money by notifing you with the latest sales, offers and coupons to redeem them you will got Discounts & Offers.
                                </p>
                ...
                <div class="row">
                    ...
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <img src="<?php echo __SCRIPT_PATH;?>assets/images/monitor.png" alt="" />
                            </div>
                        ...
                        <div class="portfolio">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <img class="portfolio-img img-responsive" src="<?php echo __SCRIPT_PATH;?>assets/images/monitor.png" alt="" />
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="container text-center">
                ...
                <div class="heading">
                    <div class="title text-center arrow-left">
                        <img class="hidden-xs" src="<?php echo __SCRIPT_PATH;?>assets/images/left-arrow.png" alt="" />
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="main-works">
                            <img src="<?php echo __SCRIPT_PATH;?>assets/images/map.png" alt="" />
                        </div>
                    </div>
                </div>	
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="features-content active"> 
                                <h4><i class="fa fa-database"></i><span>Coupones</span></h4>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="features-content"> 
                                <h4><i class="fa fa-database"></i><span>Offers</span></h4>
                                <p>orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ulla</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="features-content"> 
                                <h4><i class="fa fa-database"></i><span>Sales</span></h4>
                                <p>orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ulla</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="features-content"> 
                                <h4><i class="fa fa-database"></i><span>New Arrivals</span></h4>
                                <p>orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ulla</p>
                            </div>
                        </div>
                    ...
                    <div class="main-package text-center">
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="package-item basic">
                                ...
                                <div class="pkg-btn"><a href="" class="btn btn-primary">Register NOW</a></div>
